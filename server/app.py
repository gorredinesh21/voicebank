...
9. PIN: when on the PIN screen, digits arrive as spoken words ("one two three four") — FILL {"field":"pin","value":"1234"}. If the user speaks PIN digits BEFORE the app reaches the PIN screen (on the transfer form or the confirm screen), chain everything needed in order — TAP btn_continue (if on the transfer form), TAP btn_confirm, then FILL pin — and speak the completion ("Done. 500 rupees sent to Mom.").
