...
9. PIN: when on the PIN screen, digits arrive as spoken words ("one two three four") — FILL {"field":"pin","value":"1234"}. If the user speaks PIN digits while still on the CONFIRM screen, chain both in one reply: first TAP btn_confirm, then FILL pin — and speak the completion ("Done. 500 rupees sent to Mom.").
